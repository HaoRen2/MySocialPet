...
{
    /// <inheritdoc />
    public partial class DummyMigrationToFixState : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SugerenciaIdSugerencia = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EspecieSugerencia", x => new { x.IdEspecie, x.IdSugerencia });
                    table.ForeignKey(
                        name: "FK_EspecieSugerencia_Especie_EspecieIdEspecie",
                        column: x => x.EspecieIdEspecie,
                        principalTable: "Especie",
                        principalColumn: "IdEspecie",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EspecieSugerencia_Sugerencia_SugerenciaIdSugerencia",
                        column: x => x.SugerenciaIdSugerencia,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdEspecie = table.Column<int>(type: "int", nullable: false),
                    IdTipoVacuna = table.Column<int>(type: "int", nullable: false),
                    EdadRecomendadaSemanas = table.Column<int>(type: "int", nullable: true),
                    EsRefuerzo = table.Column<bool>(type: "bit", nullable: false),
                    Descripcion = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListaVacuna", x => x.IdPlanVacunacion);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriaSugerencia", x => new { x.IdCategoria, x.IdSugerencia });
                    table.ForeignKey(
                        name: "FK_CategoriaSugerencia_Categoria_CategoriaIdCategoria",
                        column: x => x.CategoriaIdCategoria,
                        principalTable: "Categoria",
                        principalColumn: "IdCategoria",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoriaSugerencia_Sugerencia_SugerenciaIdSugerencia",
                        column: x => x.SugerenciaIdSugerencia,
                        principalTable: "Sugerencia",
                        principalColumn: "IdSugerencia",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdRaza = table.Column<int>(type: "int", nullable: false),
                    IdSugerencia = table.Column<int>(type: "int", nullable: false),
                    RazaIdRaza = table.Column<int>(type: "int", nullable: false),
                    SugerenciaIdSugerencia = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RazaSugerencia_Raza_RazaIdRaza",
                        column: x => x.RazaIdRaza,
                        principalTable: "Raza",
                        principalColumn: "IdRaza",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RazaSugerencia_Sugerencia_SugerenciaIdSugerencia",
                        column: x => x.SugerenciaIdSugerencia,
                        principalTable: "Sugerencia",
                        principalColumn: "IdSugerencia",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FotoEtiquetaMascota_FotoAlbum_IdFoto",
                        column: x => x.IdFoto,
                        principalTable: "FotoAlbum",
                        principalColumn: "IdFoto",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FotoEtiquetaMascota_Mascota_IdMascota",
                        column: x => x.IdMascota,
                        principalTable: "Mascota",
                        principalColumn: "IdMascota",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriaSugerencia_CategoriaIdCategoria",
                table: "CategoriaSugerencia",
                column: "CategoriaIdCategoria");

            migrationBuilder.CreateIndex(
                name: "IX_CategoriaSugerencia_SugerenciaIdSugerencia",
                table: "CategoriaSugerencia",
                column: "SugerenciaIdSugerencia");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EspecieSugerencia_EspecieIdEspecie",
                table: "EspecieSugerencia",
                column: "EspecieIdEspecie");

            migrationBuilder.CreateIndex(
                name: "IX_EspecieSugerencia_SugerenciaIdSugerencia",
                table: "EspecieSugerencia",
                column: "SugerenciaIdSugerencia");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FotoEtiquetaMascota_IdMascota",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RazaSugerencia_RazaIdRaza",
                table: "RazaSugerencia",
                column: "RazaIdRaza");

            migrationBuilder.CreateIndex(
                name: "IX_RazaSugerencia_SugerenciaIdSugerencia",
                table: "RazaSugerencia",
                column: "SugerenciaIdSugerencia");
